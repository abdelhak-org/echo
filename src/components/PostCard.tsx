...
const PostCard = ({id, title,description,content,createdAt = new Date().toLocaleString(),likes = 10,
}: Post) => {
  return (
      ...
      <Card className="w-full md:w-4/5 flex flex-col justify-between border dark:bg-neutral-900">
        ...
        <CardFooter className="flex space-x-4">
          ...
          <p className="text-blue-500 relative px-2">
            <AiFillLike size={18} />
            <span className="absolute left-8 top-0 z-50 text-blue-300">{likes}</span>
          </p>
