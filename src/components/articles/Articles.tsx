...
const Articles  = async () => {
  ...
  return (
    <section className="max-w-[1080px] w-full mx-auto py-8 px-2  relative     z-50">
      ...
      <div className="flex flex-1 justify-between sm:hidden">
        ...
        <a
          href="#"
          className="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50"
        >
          Next
        </a>
      </div>
